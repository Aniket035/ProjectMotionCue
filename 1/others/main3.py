...
def main():
    ...
    st.markdown("""
        <div style='font-size: 80px;font-align: center; font-style: bold;
    font-family: comic sans ms, cursive; 
    justify-content: center; color: rgb(72, 0, 255);'>Motion Cue</div>
    """, unsafe_allow_html=True)

    st.markdown("""
            <div style='font-size: 40px;font-align: center;
        font-family: cursive; 
        justify-content: center; color: #fafafa;'>Gesture Based Navigation</div>
        """, unsafe_allow_html=True)
    # st.header("Gesture Based Navigation")

    lottie_upload = load_lottiefile("lottifilesjson/upload.json")
    st_lottie(lottie_upload, height=250, key="upload")
    ...
    if uploaded_file is not None:
        ...
        if save_uploaded_file(uploaded_file):
            ...
            st.error('Image uploaded successfully!')
